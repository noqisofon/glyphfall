...
- **本格キャラクリ「素性（出自）× 旅立ちの動機」（ADR-0022 & ADR-0023）**
  - タイトル画面から世界名・名前入力の後、2軸直交のキャラクリ画面を展開
  - **属性軸（出自）**: 商人の息子（初期350G・物資豊富）、傭兵崩れ（高HP32・戦闘特化）、元神官見習い（魔術知識65・目星60・高MP20）、農家の三男坊（頑丈なパンピー）
  - **動機軸（旅立ちの理由）**:
    - **駆け落ち者**: 相棒選択画面（エレナ/クラリス/コレット）で選んだパートナーと二人旅スタート！初期影響度は自然上限手前の**88**
    - **探し人**: 行方不明の誰かを探す単独旅。手帳に固定話題「人を探している」を獲得し、聞き込みで真相を追う
    - **復讐者**: 悲劇への報復を誓う単独旅。執念のHP+4ボーナス、話題「復讐の誓い」
    - **お尋ね者**: 逃亡資金+100G、話題「追手からの逃亡」
    - **冒険者志望**: 標準的な単独冒険者スタート
  - 選択した組み合わせに応じて主人公のHP/MP/スキル、初期資金（フォリン）、アイテム、話題、パーティ編成（1人〜2人）がゲーム開始時に完全反映
...
- [ADR-0022: 素性（出自）システムによるゲーム開始パターンの統一](docs/adr/0022-origin-based-game-start.md)
